...
class PreFxController(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.load_stimulus_ontology_action = None
        self.load_qc_criteria_action = None
        self.load_data_set_action = None
        self.load_data_set_lims_action = None
        self.show_qc_criteria_action = None
        self.show_stimulus_ontology_action = None
        self.export_manual_states_to_json_action = None
        self.export_manual_states_to_lims_action = None
        self.run_feature_extraction_action = None
