...
class SweepPlotter(object):
    ...
    def get_plot_data(self, sweep_data: dict,):
        ...
        elif self.config.backup_experiment_start_index <= num_pts:
    ...
    def gen_plots(self):
        ...
        for sweep in self._sweep_data_tuple:
            # skip "Search" sweeps or missing experiment epochs
            ...
            # # skip sweeps that are empty
            # if not tp_plot_data or not exp_plot_data:
            #     continue
