...
class SweepPlotter:
    ...
    def advance(self, sweep_number: int):
        ...
        stimulus_code = self.sweep_dictionary[sweep_number]['stimulus_code']
...
def make_plots(sweep_dictionary: Dict[int, dict], plot_output: Connection):
    # dummy return for testing
    # plot_output.send(['foo' for _ in sweep_dictionary])
    plot_output.send(sweep_dictionary)
    plot_output.close()
